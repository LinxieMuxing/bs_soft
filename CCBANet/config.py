CURRENT_DIR="."
CONFIG={
    "dataset_dir":CURRENT_DIR+"/datasets",#数据集文件夹
    "output_dir":CURRENT_DIR+"/output",#输出文件夹
    "model_dir":CURRENT_DIR+"/output/model",#模型文件夹
    "segm_dir":CURRENT_DIR+"/output/segm",#分割文件夹
    "visualize_dir":CURRENT_DIR+"/output/visualize",#可视化文件夹
    "dataset":{
    ...
    "device":"cpu",                                             #"cuda", "cpu"
    "mode":"train",                                              #"train", "test", "val"下方有三种的详细配置
    "typeloss":"BceDiceLoss",                                    #"StructureLoss", "BceDiceLoss", "BceIoULoss"损失函数类型
    ...
    "train":{                                                   #训练时的配置
        ...
        "optimizer":"Adam",                                     #"SGD", "Adam"拟合函数 优化器
        "learningschedule":"LambdaLR",                          #"LambdaLR", "MultiStepLR"学习率算法
        "optimizer_sgd":{                                       #sgd优化器的配置
            "momentum":0.9,
            "weight_decay":1e-5,
        },
        "optimizer_adam":{                                      #adam优化器的配置 代码中使用该优化器
            "betas":(0.9, 0.999),
            "eps":1e-8,
            "weight_decay":1e-5,
        },
        "schedule_lambdalr":{                                   #学习率算法的配置
            "power":0.9
        },
