...
def DeepSupervisionLoss(pred, gt,typeloss="BceDiceLoss"):#主函数调用 本文调用的BceDiceLoss loss=criteria_loss(predicts, masks,typeloss)
    ...
    gt = F.interpolate(gt, scale_factor=0.5, mode='bilinear', align_corners=True)#import torch.nn.functional as F
